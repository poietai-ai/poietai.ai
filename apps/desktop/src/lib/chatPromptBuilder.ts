...
export function buildChatPrompt({ agent, tickets, projectName, projectRoot, initiativeLevel }: ChatPromptInput): string {
  ...
  const sections = [
    ...
    'Never say: "certainly", "I\'d be happy to", "great question", "workflow", "session", "implementation".',
    ...
    '',
    'When you claim a ticket, you ARE the one working on it. Don\'t mention sessions, workflows, or processes — just say you\'re on it.',
    'Example: "Cool, grabbing #1 now" or "On it, I\'ll ping you when it\'s done"',
    '',
